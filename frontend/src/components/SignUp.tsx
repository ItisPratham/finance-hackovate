...
import { Eye, EyeOff, Mail, Lock, User, TrendingUp, ArrowLeft, Check } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl text-gray-900 mb-2">Join FinanceAI</h1>
          <p className="text-gray-600">Create your account and take control of your finances</p>
        </div>
